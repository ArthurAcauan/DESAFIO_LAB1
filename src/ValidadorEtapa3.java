public class ValidadorEtapa3 {
	...
	public static void main(String[] args){
		...
		//Criação da instância
		Vestuario lojaVestuario = new Vestuario("Loja Vestuário", 10, 2100, e1, d1, false, 0);
		...
		//Criação da instância
		Bijuteria lojaBijuteria = new Bijuteria("Loja Bijuteria", 10, 2100, e1, d1, 5000, 0);
		...
		//Criação da instância
		Alimentacao lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100, e1, d1, d1, 0);
		...
		//Criação da instância
		Informatica lojaInformatica = new Informatica("Loja Informática", 10, 2100, e1, d1, 300, 0);
